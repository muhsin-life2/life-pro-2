...
const Navbar: React.FC<NavbarProps> = ({ data, brands_data, sessionServ, isArabic, lang, langData, languageClickedToast }) => {
  const router = useRouter();
  
  const locale = router.locale;

  const t = translate(locale?locale:"en");
  ...
  function ulListTrigger(e: any, itemName: string) {
  ...
  //   router.refresh()
  // }
  const formDatahandleChange = (e:any) => {
    debugger
  ...
  const addressFormOnSubmit = (e:any) => {
    e.preventDefault();
  ...
  return (
    <>
      <div className="grid grid-flow-col  bg-pink-800 text-white  text-xs px-4 py-2  ">
        <a href="#" className="flex justify-start">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            stroke="currentColor" className="w-5 h-7 ">
            <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
          </svg>
          <div className="my-auto text-md mx-3">{t.get('navbar.highest_rated_phar')}</div>
        </a>
        <div className="text-end text-md my-auto">{t.get('navbar.download_now')}</div>
      </div>
              ...
              <div className="relative w-full">
                ...
                <div className="relative group-search bg-white  rounded-xl " id="lg-screen-search" onKeyDown={(e) => { searchButtonOnMouseEnter((e.target as HTMLInputElement).value, e.key, false) }} onMouseDown={(e) => { searchButtonOnClick(true) }}   >
                  ...
                  < input type="search" id="lg-searchbox"
                    ...
                    placeholder={t.get('navbar.searchbox_text')} />
                  ...
                  < input type="button" onClick={() => {
                    ...
                    value={t.get('navbar.searchbox_text')} />
    ...
    <MenuLanguage countrySelect={countrySelect} />
            ...
            */}
              ...
              {session ? <>
                ...
                <div className="text-[11px] text-center text-white">{t.get('navbar.account')}</div>
              </a>}
              ...
              <a href="#" className="flex flex-col md:hidden lg:flex hidden">
                ...
                <div className="text-[11px] text-center text-white">{t.get('navbar.cart')}</div>
              ...
              <a href="#" className="flex flex-col md:hidden lg:flex hidden">
                ...
                <div className="text-[11px] text-center text-white whitespace-nowrap">{t.get('navbar.wishlist')}</div>
              </a>
            </div>
          </div>
          <div className="bg-[#a92579] items-center">
            <div className=" flex justify-between py-1 px-[10px] max-w-[1450px] mx-auto text-white lg:flex md:flex hidden  text-xs " >
              <div className={"flex justify-start items-center space-x-3"}>
                <div className={`${isArabic ? 'ml-2' : 'mr-2'}`}>{t.get('navbar.highest_rated_phar')} </div>
              ...
              <div className="text-end flex justify-between items-center ">
                <div className="mx-4">{t.get('navbar.deliver_to}')}  {sessionServ?.token?.addresses && sessionServ?.token?.addresses.length != 0 ? (displayedAddress(AddressDataIndex)) : "Select a Location"}</div>
                <button
          ...
          <div className="grid grid-cols-3 gap-4  hidden lg:flex md:flex bg-white shadow-md">
            <div onMouseOver={() => setOverlay(true)} onMouseLeave={() => { setOverlay(false) }} className="group inline-block shop-by-cat ">
              <button
                ...
                <div className="text-start mt-2 float-left mr-10 text-sm group-1 ml-2 ">{t.get('navbar.shop_by_cat}')}</div>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
            ...
            <div className="flex space-x-6 ">
              <div className="group inline-block mr-2">
                <button className="hover:text-blue-500 underline-tra ml-7 py-1" data-dropdown-toggle="dropdown2">
                  ...
                  <div className=" text-start mt-2 float-left font-bold uppercase ">{t.get('navbar.brands')}</div>
                  {/* <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
              ...
              <div className="group inline-block mr-2">
                <button className="hover:text-blue-500 underline-tra py-1 group"
                  ...
                  <div className=" text-start mt-2 float-left font-bold uppercase">{t.get('navbar.offers')}</div>
                  {/* <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
              ...
              <button className=" py-1 hover:text-blue-500 underline-tra" data-dropdown-toggle="dropdown4">
                ...
                <div className="mb-1 text-start float-left uppercase font-bold">{t.get('navbar.health_packages')}</div>
                {/* <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
                  stroke="currentColor" className=" h-6 float-left mt-2 w-4">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                </svg> */}
      ...
      <div className="sm:visible md:hidden ">
        ...
        <div className="flex  bg-indigo-900 text-white text-xs px-[10px] py-1 justify-between items-center">
          <div>{t.get('navbar.deliver_to}:')}   <span className="mx-2">Business Bay, Dubai</span>  </div>
                        ...
                        >
                          <div className="relative">
                            ...
                            <input type="text" id="sm-searchbox" value={queryData} ref={input => input && input.focus()}
                              ...
                              placeholder={t.get('navbar.searchbox_text')} onKeyDown={(e) => { searchButtonOnMouseEnter((e.target as HTMLInputElement).value, e.key, true) }} />
