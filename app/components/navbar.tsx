...
">Please check your {signInUsing} and enter the OTP code  <span className="text-red-500">*</span></label>
      ...
      <div className="fixed bottom-7 left-1/2 -translate-x-1/2 md:hidden w-3/4 backdrop-blur-sm bg-opacity-95 bg-slate-100 h-20 rounded-full py-3 items-center z-30">
        <div className="flex justify-between mt-2 sm:px-16 px-6">
          <Link className="group/button" href={'/home'}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-8 h-8 fill-gray-500 my-auto group-focus/button:fill-black">
          ...
          <button data-modal-target="defaultModalsm" data-modal-toggle="defaultModalsm" className="group/button">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-8 h-8 fill-gray-500 my-auto group-focus/button:fill-black">
